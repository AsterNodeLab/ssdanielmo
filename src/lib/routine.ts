...
const dayMeta: Record<Weekday, Omit<RoutineDay, "blocks">> = {
  1: { weekday: 1, label: "Lunes", shortLabel: "Lun", subtitle: "UNAM · EDUVO · E1577", accent: "red" },
  2: { weekday: 2, label: "Martes", shortLabel: "Mar", subtitle: "UNAM · EDUVO · UVM", accent: "green" },
  3: { weekday: 3, label: "Miércoles", shortLabel: "Mié", subtitle: "UNAM · EDUVO · E1577", accent: "red" },
  4: { weekday: 4, label: "Jueves", shortLabel: "Jue", subtitle: "UNAM · EDUVO++ · E1598", accent: "violet" },
  5: { weekday: 5, label: "Viernes", shortLabel: "Vie", subtitle: "EDUVO · UVM · review", accent: "blue" },
};
...
const basicLateMorning = (prefix: string, eduvoTitle = "EDUVO Deep Work", eduvoDescription = "Producto · clientes · construcción") => [
  block(`${prefix}-unam-deep`, {
    start: "09:20",
    end: "10:50",
    title: "UNAM Deep Work",
...
const mondayBlocks: RoutineBlock[] = [
  ...
  block("mon-e1577-learn", { start: "13:05", end: "14:05", title: "E1577 · Aprender", description: "Tema nuevo · entender · probar · notas · explicar", icon: "book", kind: "classes", code: "E1577", stage: "learn" }),
  ...
  block("mon-e1577-execute", { start: "14:15", end: "14:40", title: "E1577 · Ejecutar", description: "n8n · workflow · ejemplos · errores · clase preparada", icon: "laptop", kind: "classes", code: "E1577", stage: "execute" }),
  ...
  block("mon-e1577-review", { start: "19:40", end: "20:20", title: "E1577 · Repaso final", description: "Secuencia · demo · links · dudas", icon: "book", kind: "classes", code: "E1577", stage: "review" }),
  block("mon-class", { start: "20:30", end: "22:00", title: "Clase E1577", description: "Llegar preparado · participar", icon: "graduation", kind: "class", code: "E1577", metric: "classSession" }),
...
const tuesdayBlocks: RoutineBlock[] = [
  ...
  block("tue-uvm", { start: "13:05", end: "14:05", title: "UVM", description: "Materia actual · actividad · lectura · avance semanal", icon: "graduation", kind: "uvm", metric: "uvm" }),
  block("tue-break-2", { start: "14:05", end: "14:15", title: "Descanso", description: "Pausa breve", icon: "coffee", kind: "break" }),
  block("tue-e1598-prep", { start: "14:15", end: "14:35", title: "Clases E1598", description: "Presentación · ejercicio · links", icon: "book", kind: "classes", code: "E1598" }),
  ...
  block("tue-unam-recall", { start: "19:40", end: "20:10", title: "UNAM Recall", description: "Flashcards · preguntas · 2–3 ejercicios", icon: "brain", kind: "unam", metric: "unamRecall" }),
  block("tue-top-ready", { start: "20:10", end: "20:20", title: "Clases · listo", description: "Abrir clase · agua · entrar", icon: "check", kind: "classes", code: "E1598" }),
  block("tue-class", { start: "20:30", end: "22:00", title: "Clase E1598", description: "Llegar listo · tomar lo esencial", icon: "graduation", kind: "class", code: "E1598", metric: "classSession" }),
...
const wednesdayBlocks: RoutineBlock[] = [
  ...
  block("wed-e1577-learn", { start: "13:05", end: "14:05", title: "E1577 · Aprender", description: "Tema nuevo · dominar concepto", icon: "book", kind: "classes", code: "E1577", stage: "learn" }),
  block("wed-reset-1", { start: "14:05", end: "14:15", title: "Reset", description: "Cambiar de contexto", icon: "refresh", kind: "break" }),
  block("wed-e1577-execute", { start: "14:15", end: "14:40", title: "E1577 · Ejecutar", description: "n8n · demo · errores · ejemplos", icon: "laptop", kind: "classes", code: "E1577", stage: "execute" }),
  ...
  block("wed-e1577-review", { start: "19:40", end: "20:20", title: "E1577 · Repaso final", description: "Secuencia · demo · links · dudas", icon: "book", kind: "classes", code: "E1577", stage: "review" }),
  block("wed-class", { start: "20:30", end: "22:00", title: "Clase E1577", description: "Llegar preparado · participar", icon: "graduation", kind: "class", code: "E1577", metric: "classSession" }),
...
const thursdayBlocks: RoutineBlock[] = [
  ...
  block("thu-top-check", { start: "14:15", end: "14:35", title: "Clases", description: "Chequeo rápido únicamente", icon: "book", kind: "classes", code: "E1598" }),
  ...
  block("thu-unam-recall", { start: "19:40", end: "20:10", title: "UNAM Recall", description: "Flashcards · preguntas · ejercicios", icon: "brain", kind: "unam", metric: "unamRecall" }),
  block("thu-class-ready", { start: "20:10", end: "20:20", title: "Preparar clase", description: "Abrir links · entrar", icon: "check", kind: "classes", code: "E1598" }),
  block("thu-class", { start: "20:30", end: "22:00", title: "Clases E1598", description: "Clase · capturar lo esencial", icon: "graduation", kind: "class", code: "E1598", metric: "classSession" }),
...
const fridayBlocks: RoutineBlock[] = [
  ...
  block("fri-unam-deep", { start: "09:20", end: "10:50", title: "UNAM · cierre semanal", description: "Cerrar aprendizaje académico de la semana", icon: "brain", kind: "unam", metric: "unamDeep", tags: ["prioridad"] }),
  ...
  block("fri-uvm", { start: "13:05", end: "14:05", title: "UVM", description: "Entregas · avance · lectura · próxima semana encaminada", icon: "graduation", kind: "uvm", metric: "uvm" }),
  ...
  block("fri-flex", { start: "19:40", end: "20:40", title: "Flex", description: "UNAM · EDUVO · UVM solamente si hace falta", icon: "focus", kind: "flex" }),
...
export const ANCHORS = [
  { time: "09:20", label: "UNAM", icon: "brain" as const },
...
export function getWeekMetrics(dates: Date[], data: AppData): WeekMetrics {
  ...
  for (const day of daily) {
    ...
    if (countCompletedMetric(blocks, record, "classSession")) classSessions += 1;
    if (countCompletedMetric(blocks, record, "uvm")) uvm += 1;
